...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		{"Code", &gti.Field{Name: "Code", Type: "github.com/emer/emergent/v2/popcode.PopCodes", LocalType: "PopCodes", Doc: "how to encode the value", Directives: gti.Directives{}, Tag: ""}},
		{"Min", &gti.Field{Name: "Min", Type: "goki.dev/mat32.Vec2", LocalType: "mat32.Vec2", Doc: "minimum value representable on each dim -- for GaussBump, typically include extra to allow mean with activity on either side to represent the lowest value you want to encode", Directives: gti.Directives{}, Tag: ""}},
		{"Max", &gti.Field{Name: "Max", Type: "goki.dev/mat32.Vec2", LocalType: "mat32.Vec2", Doc: "maximum value representable on each dim -- for GaussBump, typically include extra to allow mean with activity on either side to represent the lowest value you want to encode", Directives: gti.Directives{}, Tag: ""}},
		{"Sigma", &gti.Field{Name: "Sigma", Type: "goki.dev/mat32.Vec2", LocalType: "mat32.Vec2", Doc: "sigma parameters of a gaussian specifying the tuning width of the coarse-coded units, in normalized 0-1 range", Directives: gti.Directives{}, Tag: "def:\"0.2\" viewif:\"Code=GaussBump\""}},
