...
var _ = types.AddType(&types.Type{Name: "github.com/emer/emergent/v2/emer.Prjn", IDName: "prjn", Doc: "Prjn defines the basic interface for a projection which connects two layers.\nName is set automatically to: SendLay().Name() + \"To\" + RecvLay().Name()"})

var _ = types.AddType(&types.Type{Name: "github.com/emer/emergent/v2/emer.Prjns", IDName: "prjns", Doc: "Prjns is a slice of projections"})

var _ = types.AddType(&types.Type{Name: "github.com/emer/emergent/v2/emer.PrjnType", IDName: "prjn-type", Doc: "PrjnType is the type of the projection (extensible for more specialized algorithms).\nClass parameter styles automatically key off of these types."})
