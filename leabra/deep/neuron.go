...
type Neuron struct {
	...
	DeepCtxtGe    float32 `desc:"Current excitatory conductance for temporally-delayed local integration of DeepBurst signals sent via BurstCtxt projection into separate Deep layer neurons, which represent the activation of layer 6 CT corticothalamic neurons.  DeepCtxt is updated at end of a DeepBurst quarter, and thus takes effect during subsequent quarter(s) until updated again."`
