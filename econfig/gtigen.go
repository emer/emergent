...
var _ = gti.AddType(&gti.Type{Name: "github.com/emer/emergent/v2/econfig.Includer", IDName: "includer", Doc: "Includer enables processing of Include string field with file to include in Config objects."})
