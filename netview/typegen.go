...
var _ = types.AddType(&types.Type{Name: "github.com/emer/emergent/v2/netview.PrjnData", IDName: "prjn-data", Doc: "PrjnData holds display state for a projection", Fields: []types.Field{{Name: "Send", Doc: "name of sending layer"}, {Name: "Recv", Doc: "name of recv layer"}, {Name: "Prjn", Doc: "source projection"}, {Name: "SynData", Doc: "synaptic data, by variable in SynVars and number of data points"}}})
...
func (t *NetView) SetColorMapVal(v *views.ColorMapValue) *NetView { t.ColorMapVal = v; return t }
...
var _ = types.AddType(&types.Type{Name: "github.com/emer/emergent/v2/netview.Params", IDName: "params", Doc: "Params holds parameters controlling how the view is rendered", Directives: []types.Directive{{Tool: "types", Directive: "add"}}, Fields: []types.Field{{Name: "Raster", Doc: "raster plot parameters"}, {Name: "NoSynData", Doc: "do not record synapse level data -- turn this on for very large networks where recording the entire synaptic state would be prohibitive"}, {Name: "PrjnType", Doc: "if non-empty, this is the type projection to show when there are multiple projections from the same layer -- e.g., Inhib, Lateral, Forward, etc"}, {Name: "MaxRecs", Doc: "maximum number of records to store to enable rewinding through prior states"}, {Name: "NVarCols", Doc: "number of variable columns"}, {Name: "UnitSize", Doc: "size of a single unit, where 1 = full width and no space.. .9 default"}, {Name: "LayNmSize", Doc: "size of the layer name labels -- entire network view is unit sized"}, {Name: "ColorMap", Doc: "name of color map to use"}, {Name: "ZeroAlpha", Doc: "opacity (0-1) of zero values -- greater magnitude values become increasingly opaque on either side of this minimum"}, {Name: "NetView", Doc: "our netview, for update method"}, {Name: "NFastSteps", Doc: "the number of records to jump for fast forward/backward"}}})
