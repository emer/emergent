...
var _ = types.AddType(&types.Type{Name: "github.com/emer/emergent/v2/netview.sideData", IDName: "side-data", Fields: []types.Field{{Name: "pth"}, {Name: "rSide"}}})
