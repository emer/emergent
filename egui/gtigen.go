...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Plots", &gti.Field{Name: "Plots", Type: "map[github.com/emer/emergent/v2/etime.ScopeKey]*github.com/emer/etable/v2/eplot.Plot2D", LocalType: "map[etime.ScopeKey]*eplot.Plot2D", Doc: "plots by scope", Directives: gti.Directives{}, Tag: ""}},
		{"TableViews", &gti.Field{Name: "TableViews", Type: "map[github.com/emer/emergent/v2/etime.ScopeKey]*github.com/emer/etable/v2/etview.TableView", LocalType: "map[etime.ScopeKey]*etview.TableView", Doc: "plots by scope", Directives: gti.Directives{}, Tag: ""}},
		{"Grids", &gti.Field{Name: "Grids", Type: "map[string]*github.com/emer/etable/v2/etview.TensorGrid", LocalType: "map[string]*etview.TensorGrid", Doc: "tensor grid views by name -- used e.g., for Rasters or ActRFs -- use Grid(name) to access", Directives: gti.Directives{}, Tag: ""}},
		...
		{"StructView", &gti.Field{Name: "StructView", Type: "*goki.dev/giv.StructView", LocalType: "*giv.StructView", Doc: "displays Sim fields on left", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		{"Tabs", &gti.Field{Name: "Tabs", Type: "*goki.dev/gi.Tabs", LocalType: "*gi.Tabs", Doc: "tabs for different view elements: plots, rasters", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		{"Body", &gti.Field{Name: "Body", Type: "*goki.dev/gi.Body", LocalType: "*gi.Body", Doc: "Body is the content of the sim window", Directives: gti.Directives{}, Tag: "view:\"-\""}},
	}),
