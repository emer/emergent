...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Scale", &gti.Field{Name: "Scale", Type: "goki.dev/mat32/v2.Vec2", LocalType: "mat32.Vec2", Doc: "scaling to apply to receiving unit position to compute sending center as function of recv unit position", Directives: gti.Directives{}, Tag: ""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Scale", &gti.Field{Name: "Scale", Type: "goki.dev/mat32/v2.Vec2", LocalType: "mat32.Vec2", Doc: "scaling to apply to receiving pool osition to compute corresponding position in sending layer of the lower-left corner of rectangle", Directives: gti.Directives{}, Tag: ""}},
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"TopoRange", &gti.Field{Name: "TopoRange", Type: "goki.dev/etable/v2/minmax.F32", LocalType: "minmax.F32", Doc: "min..max range of topographic weight values to generate", Directives: gti.Directives{}, Tag: ""}},
	}),
	Embeds:  ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{}),
	Methods: ordmap.Make([]ordmap.KeyVal[string, *gti.Method]{}),
})
...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"Scale", &gti.Field{Name: "Scale", Type: "goki.dev/mat32/v2.Vec2", LocalType: "mat32.Vec2", Doc: "scaling to apply to receiving unit position to compute corresponding position in sending layer of the lower-left corner of rectangle", Directives: gti.Directives{}, Tag: ""}},
