...
func init() {
	Symbols["github.com/emer/emergent/v2/netview/netview"] = map[string]reflect.Value{
		...
		"RasterSettings": reflect.ValueOf((*netview.RasterSettings)(nil)),
		"Scene":          reflect.ValueOf((*netview.Scene)(nil)),
		"Settings":       reflect.ValueOf((*netview.Settings)(nil)),
		"VarSettings":    reflect.ValueOf((*netview.VarSettings)(nil)),
