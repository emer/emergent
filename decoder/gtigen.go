...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"ValsTsrs", &gti.Field{Name: "ValsTsrs", Type: "map[string]*github.com/emer/etable/v2/etensor.Float32", LocalType: "map[string]*etensor.Float32", Doc: "for holding layer values", Directives: gti.Directives{}, Tag: "view:\"-\""}},
		{"Weights", &gti.Field{Name: "Weights", Type: "github.com/emer/etable/v2/etensor.Float32", LocalType: "etensor.Float32", Doc: "synaptic weights: outer loop is units, inner loop is inputs", Directives: gti.Directives{}, Tag: ""}},
		...
		{"MPIDWts", &gti.Field{Name: "MPIDWts", Type: "github.com/emer/etable/v2/etensor.Float32", LocalType: "etensor.Float32", Doc: "delta weight changes: only for MPI mode -- outer loop is units, inner loop is inputs", Directives: gti.Directives{}, Tag: ""}},
	}),
