...
var _ = types.AddType(&types.Type{Name: "github.com/emer/emergent/v2/weights.Layer", IDName: "layer", Doc: "Layer is temp structure for holding decoded weights, one for each layer", Fields: []types.Field{{Name: "Layer"}, {Name: "MetaData"}, {Name: "Units"}, {Name: "Prjns"}}})

var _ = types.AddType(&types.Type{Name: "github.com/emer/emergent/v2/weights.Prjn", IDName: "prjn", Doc: "Prjn is temp structure for holding decoded weights, one for each projection", Fields: []types.Field{{Name: "From"}, {Name: "MetaData"}, {Name: "MetaValues"}, {Name: "Rs"}}})
