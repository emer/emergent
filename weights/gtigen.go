...
var _ = gti.AddType(&gti.Type{Name: "github.com/emer/emergent/v2/weights.Prjn", IDName: "prjn", Doc: "Prjn is temp structure for holding decoded weights, one for each projection", Fields: []gti.Field{{Name: "From"}, {Name: "MetaData"}, {Name: "MetaValues"}, {Name: "Rs"}}})
