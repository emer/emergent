...
var _ = gti.AddType(&gti.Type{
	...
	Fields: ordmap.Make([]ordmap.KeyVal[string, *gti.Field]{
		...
		{"F32Tensors", &gti.Field{Name: "F32Tensors", Type: "map[string]*github.com/emer/etable/v2/etensor.Float32", LocalType: "map[string]*etensor.Float32", Doc: "float32 tensors used for grabbing values from layers", Directives: gti.Directives{}, Tag: ""}},
		{"F64Tensors", &gti.Field{Name: "F64Tensors", Type: "map[string]*github.com/emer/etable/v2/etensor.Float64", LocalType: "map[string]*etensor.Float64", Doc: "float64 tensors as needed for other computations", Directives: gti.Directives{}, Tag: ""}},
		{"IntTensors", &gti.Field{Name: "IntTensors", Type: "map[string]*github.com/emer/etable/v2/etensor.Int", LocalType: "map[string]*etensor.Int", Doc: "int tensors as needed for other computations", Directives: gti.Directives{}, Tag: ""}},
		...
		{"SimMats", &gti.Field{Name: "SimMats", Type: "map[string]*github.com/emer/etable/v2/simat.SimMat", LocalType: "map[string]*simat.SimMat", Doc: "similarity matrix for comparing pattern similarities", Directives: gti.Directives{}, Tag: ""}},
		{"Plots", &gti.Field{Name: "Plots", Type: "map[string]*github.com/emer/etable/v2/eplot.Plot2D", LocalType: "map[string]*eplot.Plot2D", Doc: "analysis plots -- created by analysis routines", Directives: gti.Directives{}, Tag: ""}},
		{"PCA", &gti.Field{Name: "PCA", Type: "github.com/emer/etable/v2/pca.PCA", LocalType: "pca.PCA", Doc: "one PCA object can be reused for all PCA computations", Directives: gti.Directives{}, Tag: ""}},
		{"SVD", &gti.Field{Name: "SVD", Type: "github.com/emer/etable/v2/pca.SVD", LocalType: "pca.SVD", Doc: "one SVD object can be reused for all SVD computations", Directives: gti.Directives{}, Tag: ""}},
